...
?>
	<div class="container">
		...
		<div class="col-md-6 ab-left">
			<img src="<?php echo get_template_directory_uri()?>/images/ab.png" alt=" " />
		</div>
		...
		<div class="w3-agileits-team-title">
			...
			<div id="horizontalTab">
				<ul class="col-md-2 resp-tabs-list">
					<li>
						<img src="<?php echo get_template_directory_uri()?>/<?php echo get_template_directory_uri()?>/images/tab1.jpg" alt=" " class="img-responsive" />
					</li>
					<li>
						<img src="<?php echo get_template_directory_uri()?>/<?php echo get_template_directory_uri()?>/images/tab4.jpg" alt=" " class="img-responsive" />
					</li>
					<li>
						<img src="<?php echo get_template_directory_uri()?>/<?php echo get_template_directory_uri()?>/images/tab3.jpg" alt=" " class="img-responsive" />
					</li>
					<li>
						<img src="<?php echo get_template_directory_uri()?>/<?php echo get_template_directory_uri()?>/images/tab2.jpg" alt=" " class="img-responsive" />
					</li>
				</ul>
